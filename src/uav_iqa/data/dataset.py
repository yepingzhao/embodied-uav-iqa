...
from uav_iqa.domain import SUBTASK_NAME_TO_ID
from uav_iqa.utils import load_image_tensor
from .samples import load_processed_entries

_log = logging.getLogger(__name__)


class UAVQualityDataset(Dataset):
    ...
    def _load(self) -> List[dict]:
        ...
        for entry in load_processed_entries(self.data_root, self.split):
