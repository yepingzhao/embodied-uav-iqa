...
Provides the multi-UAV distortion synthesis composition root.
...
# ===========================================================================
# Dataset adapters are defined in ``data.adapters``.
# ===========================================================================


class DistortionSynthesisPipeline:
    ...
    def __init__(self, dataset_adapter: DatasetAdapter, seed: int = 42):
...
def create_pipeline(dataset: str = "aircopbench", seed: int = 42) -> DistortionSynthesisPipeline:
    """Create a ``DistortionSynthesisPipeline`` for a named dataset adapter.

    Example:
        >>> pipeline = create_pipeline("aircopbench")
        >>> pipeline.inject_distortions("data/raw/AirCopBench", "data/processed")
    """
    adapter_cls = DatasetAdapter.get(dataset)
    return DistortionSynthesisPipeline(adapter_cls(), seed=seed)
