...
class UAVQualityDataModule(L.LightningDataModule):
    ...
    def __init__(
        ...
        self.train_dataset: Optional[UAVQualityDataset] = None
        self.val_dataset: Optional[UAVQualityDataset] = None
        self.test_dataset: Optional[UAVQualityDataset] = None

    def _make_dataset(self, split: str, augment: bool = False) -> UAVQualityDataset:
        ds = UAVQualityDataset(
    ...
    def train_dataloader(self) -> DataLoader:
        return DataLoader(
            ...
            pin_memory=True,
            collate_fn=UAVQualityDataset.collate_fn,
        )
